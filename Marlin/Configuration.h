...
#define STRING_CONFIG_H_AUTHOR "Clinton Blackmore, FT-5 R1 Dual Z" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "FT5-R1.DZ M1.1.9" // Folgertech FT-5, revision 1, with Dual Z mod, running Marlin 1.1.9
...
// CWB -- it is curious that we've redefined constants for the FT-5
// but PIDTEMPBED is not enabled.
...
#define DEFAULT_bedKp 142.35
#define DEFAULT_bedKi 21.19
#define DEFAULT_bedKd 239.06
 ...
 */
// In FT config, these are 15 when the default was 20
// Now the default is 10, so I'll stick with it
...
#define Z_PROBE_OFFSET_RANGE_MAX -0.01
...
// Should make it easier to level - CWB
